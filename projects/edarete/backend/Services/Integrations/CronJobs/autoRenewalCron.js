...
class AutoRenewalCron {
  ...
  async processPaymentAttempt(subscription, allowRetries = true) {
    try {
      ...
      try {
        ...
        const paymentMethodRouter = require('../../../Src/HelperFunctions/PreProcessingFunctions/PaymentPlan/paymentMethodRouter');
  ...
  async callPaymentPlanHandler(subscription, status, paymentResult) {
    try {
      ...
      const paymentPlanHandler = require('../../../Src/HelperFunctions/PostProcessingFunctions/PaymentPlan/paymentPlanHandler');
