global.CoursetimetablesscheduleDropdown_object = {
        versions: {
          versionData: [
            {
              "*": {
                steps: [
                  ...
                  platform:
                    ...
                    response: {
                      successMessage: "coursetimetablesschedule retrieved successfully!",
      ...
      module.exports = { CoursetimetablesscheduleDropdown_object }