const parameters = require('./CRUD_parameters');
        global.GroupedCrudsIncoming_audit_logs_object = {
          versions: {
            versionData: [
              {
                "*": {
        ...
        module.exports = {GroupedCrudsIncoming_audit_logs_object}