const parameters = require('./CRUD_parameters');
        global.GroupedCrudsOutgoing_audit_logs_object = {
          versions: {
            versionData: [
              {
                "*": {
        ...
        module.exports = {GroupedCrudsOutgoing_audit_logs_object}