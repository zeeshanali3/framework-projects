                      ...
                      apiInfo: {
                        ...
                        queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                          ...
                          queryPayload: {
                            ...
                            List: async(req, decryptedPayload) => { return "SELECT COUNT(*) OVER () AS table_count, permission_groups_permissions.permission_group_permission_id as permissionGroupsPermissions_id, permission_groups_permissions.permission_group_permission_id as id, permission_groups_permissions.permission_group_permission_id as permissionGroupsPermissions_permissionGroupsPermissionId,permission_groups_permissions.group_id as permissionGroupsPermissions_groupId,permission_groups_permissions.permission_id as permissionGroupsPermissions_permissionId,permission_groups_permissions.status as permissionGroupsPermissions_status,permission_groups_permissions.updated_by as permissionGroupsPermissions_updatedBy,permission_groups_permissions.updated_at as permissionGroupsPermissions_updatedAt,permission_groups_permissions.created_at as permissionGroupsPermissions_createdAt,permission_groups_permissions.created_by as permissionGroupsPermissions_createdBy, permission_groups.group_name as permission_groups_groupName,permissions.permission_name as permissions_permissionName FROM permission_groups_permissions LEFT JOIN permission_groups ON permission_groups_permissions.group_id = permission_groups.permission_group_id LEFT JOIN permissions ON permission_groups_permissions.permission_id = permissions.permission_id Where permission_groups_permissions.status != 'inactive' "},
