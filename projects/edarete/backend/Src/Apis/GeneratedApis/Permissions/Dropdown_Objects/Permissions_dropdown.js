                  ...
                  platform:
                    ...
                    data: {
                      ...
                      apiInfo: {
                        ...
                        preProcessFunction : [],
                        query: {
                          "queryPayload": "SELECT LEFT(permission_name, 50) as label, permission_id as value FROM permissions where permissions.status!='inactive'",
                        },
                        database: "mainDb",
                        utilityFunctions: {
                      ...
                      requestMetaData: {
                        requestMethod: "GET",
                        permission: "dropdown_permissions",
