const parameters = {
              ...
              "colMapper": "{ 'programs_programId' : 'program_id',  'programs_departmentId' : 'department_id',  'programs_domainId' : 'domain_id',  'programs_programName' : 'program_name',  'programs_programYear' : 'program_year',  'departments_departmentId' : 'department_id',  'departments_departmentName' : 'department_name',  'departments_employeeId' : 'employee_id',  'domains_domainId' : 'domain_id',  'domains_domainName' : 'domain_name',  'domains_domainLeaderId' : 'domain_leader_id',  'plo_ploid' : 'ploid',  'plo_programId' : 'program_id',  'plo_ploname' : 'ploname',  'plo_plonum' : 'plonum',  'semesters_semesterId' : 'semester_id',  'semesters_programId' : 'program_id',  'semesters_semesterNum' : 'semester_num',  'semesters_startDate' : 'start_date',  'semesters_endDate' : 'end_date',  'semesters_semesterName' : 'semester_name',  'students_studentUserId' : 'student_user_id',  'students_urddId' : 'urdd_id',  'students_programId' : 'program_id',  'students_batch' : 'batch',  'students_regNum' : 'reg_num'}"
          };
