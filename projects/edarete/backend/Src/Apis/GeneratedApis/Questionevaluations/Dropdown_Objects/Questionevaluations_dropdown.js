global.QuestionevaluationsDropdown_object = {
        versions: {
          versionData: [
            {
              "*": {
                steps: [
                  ...
                  platform:
                    ...
                    data: {
                      ...
                      requestMetaData: {
                        requestMethod: "GET",
                        permission: "dropdown_questionevaluations",
                        providedPermissions: false,
                        pagination: { pageSize: 10 },
                      },
                    },
                    response: {
                      successMessage: "questionevaluations retrieved successfully!",
      ...
      module.exports = { QuestionevaluationsDropdown_object }