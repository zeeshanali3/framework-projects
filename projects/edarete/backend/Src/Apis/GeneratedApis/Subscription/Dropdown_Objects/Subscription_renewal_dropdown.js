global.Subscription_renewalDropdown_object = {
        versions: {
          versionData: [
            {
              "*": {
                steps: [
                  ...
                  platform:
                    ...
                    response: {
                      successMessage: "subscription_renewal retrieved successfully!",
      ...
      module.exports = { Subscription_renewalDropdown_object }