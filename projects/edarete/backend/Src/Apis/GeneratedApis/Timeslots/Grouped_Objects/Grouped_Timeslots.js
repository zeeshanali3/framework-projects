                        ...
                        apiInfo: {
                          ...
                          queryNature: { Add: "INSERT", Update: "UPDATE", View: "SELECT", Delete: "DELETE", List: "SELECT" },
                            queryPayload: {
                              ...
                              Update: async(req, decryptedPayload) => { return "UPDATE timeslots SET start_time = {{timeslots_startTime}}, end_time = {{timeslots_endTime}}, day = {{timeslots_day}}, created_by = {{timeslots_createdBy}}, updated_by = {{timeslots_updatedBy}} WHERE time_slot_id = {{id}}"},
