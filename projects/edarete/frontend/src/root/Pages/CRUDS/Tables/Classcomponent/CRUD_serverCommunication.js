            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_classcomponent',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/classcomponent?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_classcomponent',
                    ...
                    export: {
                      permission: 'export_classcomponent',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_classcomponent',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "classcomponent_componentId", "classcomponent_courseId", "classcomponent_componentType", "classcomponent_componentName", "classcomponent_weightage", "classcomponent_componentPolicy", "classcomponent_status", "classcomponent_createdBy", "classcomponent_updatedBy", "classcomponent_createdAt", "classcomponent_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_classcomponent',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_classcomponent',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/classcomponent?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_classcomponent',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/classcomponent?version=1.0",
                          apiActionType: "classcomponent_view",
                          requestType: "GET",
                          reduxActionType: "classcomponent_view",
                      }),
                      options: {
                          pageSize: 10,
