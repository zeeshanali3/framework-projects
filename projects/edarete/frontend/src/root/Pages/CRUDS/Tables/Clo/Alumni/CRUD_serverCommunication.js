            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_alumni',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/alumni?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "alumni_alumniId", "alumni_userRoleId", "alumni_graduatingYear", "alumni_employementDetail", "alumni_status", "alumni_createdBy", "alumni_updatedBy", "alumni_createdAt", "alumni_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/alumni?version=1.0",
                          apiActionType: "alumni_view",
                          requestType: "GET",
                          reduxActionType: "alumni_view",
                      }),
                      options: {
                          pageSize: 10,
