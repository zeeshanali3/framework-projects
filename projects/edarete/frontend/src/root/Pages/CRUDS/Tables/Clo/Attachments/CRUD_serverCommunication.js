                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/attachments?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "attachments_attachmentId", "attachments_attachmentName", "attachments_attachmentType", "attachments_attachmentSize", "attachments_attachmentLink", "attachments_createdBy", "attachments_updatedBy", "attachments_status", "attachments_createdAt", "attachments_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/attachments?version=1.0",
                          apiActionType: "attachments_view",
                          requestType: "GET",
                          reduxActionType: "attachments_view",
                      }),
                      options: {
                          pageSize: 10,
