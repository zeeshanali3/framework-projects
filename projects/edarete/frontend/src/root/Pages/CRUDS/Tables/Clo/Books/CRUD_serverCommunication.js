/* Frontend Objects for table: books */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_books',
                        onAction: () => console.log("Button pressed Edit"),
                        form: books generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/books?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "books_bookId", "books_courseId", "books_bookIbn", "books_bookName", "books_status", "books_createdBy", "books_updatedBy", "books_createdAt", "books_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/books?version=1.0",
                        apiActionType: "books_view",
                        requestType: "GET",
                        reduxActionType: "books_view",
                    }),
                    options: {
                        pageSize: 10,
