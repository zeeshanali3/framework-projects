import { parameters } from "./CRUD_parameters.js";
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    options: {
                        filterBy: [
                            "clo_cloid", "clo_clonum", "clo_clodomainName", "clo_description", "clo_status", "clo_createdBy", "clo_updatedBy", "clo_createdAt", "clo_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/clo?version=1.0",
                          apiActionType: "clo_view",
                          requestType: "GET",
                          reduxActionType: "clo_view",
                      }),
                      options: {
                          pageSize: 10,
