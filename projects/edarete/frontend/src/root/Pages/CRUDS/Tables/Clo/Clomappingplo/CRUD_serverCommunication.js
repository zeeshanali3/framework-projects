            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_clomappingplo',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/clomappingplo?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_clomappingplo',
                    ...
                    export: {
                      permission: 'export_clomappingplo',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_clomappingplo',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "clomappingplo_clomappingPloid", "clomappingplo_cloid", "clomappingplo_clointensityName", "clomappingplo_ploid", "clomappingplo_status", "clomappingplo_createdBy", "clomappingplo_updatedBy", "clomappingplo_createdAt", "clomappingplo_updatedAt"
                        ],
                    ...
                    search: {
                    permission: 'search_clomappingplo',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/clomappingplo?version=1.0",
                          apiActionType: "clomappingplo_view",
                          requestType: "GET",
                          reduxActionType: "clomappingplo_view",
                      }),
                      options: {
                          pageSize: 10,
