            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_coursefeedbackform',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/coursefeedbackform?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_coursefeedbackform',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_coursefeedbackform',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/coursefeedbackform?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_coursefeedbackform',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_coursefeedbackform',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "coursefeedbackform_courseFeedBackFormId", "coursefeedbackform_courseId", "coursefeedbackform_feedbackFormId", "coursefeedbackform_status", "coursefeedbackform_createdBy", "coursefeedbackform_updatedBy", "coursefeedbackform_createdAt", "coursefeedbackform_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_coursefeedbackform',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_coursefeedbackform',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/coursefeedbackform?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_coursefeedbackform',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/coursefeedbackform?version=1.0",
                          apiActionType: "coursefeedbackform_view",
                          requestType: "GET",
                          reduxActionType: "coursefeedbackform_view",
                      }),
                      options: {
                          pageSize: 10,
