/* Frontend Objects for table: courseleaderboards */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_courseleaderboards',
                        onAction: () => console.log("Button pressed Edit"),
                        form: courseleaderboards generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/courseleaderboards?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_courseleaderboards',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_courseleaderboards',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/courseleaderboards?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_courseleaderboards',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_courseleaderboards',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "courseleaderboards_courseLeaderboardId", "courseleaderboards_courseId", "courseleaderboards_leaderboardName", "courseleaderboards_numberOfPositions", "courseleaderboards_status", "courseleaderboards_createdBy", "courseleaderboards_updatedBy", "courseleaderboards_createdAt", "courseleaderboards_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_courseleaderboards',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_courseleaderboards',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/courseleaderboards?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_courseleaderboards',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/courseleaderboards?version=1.0",
                        apiActionType: "courseleaderboards_view",
                        requestType: "GET",
                        reduxActionType: "courseleaderboards_view",
                    }),
                    options: {
                        pageSize: 10,
