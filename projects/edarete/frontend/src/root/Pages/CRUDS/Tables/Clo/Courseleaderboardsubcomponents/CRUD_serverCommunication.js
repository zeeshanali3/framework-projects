/* Frontend Objects for table: courseleaderboardsubcomponents */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_courseleaderboardsubcomponents',
                        onAction: () => console.log("Button pressed Edit"),
                        form: courseleaderboardsubcomponents generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/courseleaderboardsubcomponents?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_courseleaderboardsubcomponents',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_courseleaderboardsubcomponents',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/courseleaderboardsubcomponents?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_courseleaderboardsubcomponents',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_courseleaderboardsubcomponents',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "courseleaderboardsubcomponents_courseLeaderboardSubcomponentId", "courseleaderboardsubcomponents_courseLeaderboardId", "courseleaderboardsubcomponents_subComponentId", "courseleaderboardsubcomponents_subcomponentPercentage", "courseleaderboardsubcomponents_status", "courseleaderboardsubcomponents_createdBy", "courseleaderboardsubcomponents_updatedBy", "courseleaderboardsubcomponents_createdAt", "courseleaderboardsubcomponents_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_courseleaderboardsubcomponents',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_courseleaderboardsubcomponents',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/courseleaderboardsubcomponents?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_courseleaderboardsubcomponents',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/courseleaderboardsubcomponents?version=1.0",
                        apiActionType: "courseleaderboardsubcomponents_view",
                        requestType: "GET",
                        reduxActionType: "courseleaderboardsubcomponents_view",
                    }),
                    options: {
                        pageSize: 10,
