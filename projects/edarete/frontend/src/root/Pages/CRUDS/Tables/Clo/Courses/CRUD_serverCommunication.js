/* Frontend Objects for table: courses */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: courses generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/courses?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/courses?version=1.0",
                        apiActionType: "courses_view",
                        requestType: "GET",
                        reduxActionType: "courses_view",
                    }),
                    options: {
                        pageSize: 10,
