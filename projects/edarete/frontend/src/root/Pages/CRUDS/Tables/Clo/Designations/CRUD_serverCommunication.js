/* Frontend Objects for table: designations */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_designations',
                        onAction: () => console.log("Button pressed Edit"),
                        form: designations generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/designations?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    export: {
                      permission: 'export_designations',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_designations',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "designations_designationId", "designations_designationName", "designations_seniorDesignationId", "designations_createdBy", "designations_updatedBy", "designations_status", "designations_createdAt", "designations_updatedAt"
                        ],
                    ...
                    search: {
                    permission: 'search_designations',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/designations?version=1.0",
                        apiActionType: "designations_view",
                        requestType: "GET",
                        reduxActionType: "designations_view",
                    }),
                    options: {
                        pageSize: 10,
