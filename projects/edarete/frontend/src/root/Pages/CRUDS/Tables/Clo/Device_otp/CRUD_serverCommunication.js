/* Frontend Objects for table: device_otp */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: device_otp generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/device_otp?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "device_otp_deviceOtpId", "device_otp_userDeviceId", "device_otp_otp", "device_otp_otpFailureCount", "device_otp_createdBy", "device_otp_updatedBy", "device_otp_status", "device_otp_createdAt", "device_otp_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/device_otp?version=1.0",
                        apiActionType: "device_otp_view",
                        requestType: "GET",
                        reduxActionType: "device_otp_view",
                    }),
                    options: {
                        pageSize: 10,
