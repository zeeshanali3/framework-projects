/* Frontend Objects for table: feedbackform */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_feedbackform',
                        onAction: () => console.log("Button pressed Edit"),
                        form: feedbackform generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/feedbackform?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_feedbackform',
                    ...
                    export: {
                      permission: 'export_feedbackform',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_feedbackform',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_feedbackform',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/feedbackform?version=1.0",
                        apiActionType: "feedbackform_view",
                        requestType: "GET",
                        reduxActionType: "feedbackform_view",
                    }),
                    options: {
                        pageSize: 10,
