/* Frontend Objects for table: feedbacks */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_feedbacks',
                        onAction: () => console.log("Button pressed Edit"),
                        form: feedbacks generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/feedbacks?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "feedbacks_feedbackId", "feedbacks_enrollementId", "feedbacks_feedbackQuestionId", "feedbacks_feedbackText", "feedbacks_status", "feedbacks_createdBy", "feedbacks_updatedBy", "feedbacks_createdAt", "feedbacks_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/feedbacks?version=1.0",
                        apiActionType: "feedbacks_view",
                        requestType: "GET",
                        reduxActionType: "feedbacks_view",
                    }),
                    options: {
                        pageSize: 10,
