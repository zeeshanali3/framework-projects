            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_institutes',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/institutes?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "institutes_instituteId", "institutes_instituteName", "institutes_instituteEmailDomain"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/institutes?version=1.0",
                          apiActionType: "institutes_view",
                          requestType: "GET",
                          reduxActionType: "institutes_view",
                      }),
                      options: {
                          pageSize: 10,
