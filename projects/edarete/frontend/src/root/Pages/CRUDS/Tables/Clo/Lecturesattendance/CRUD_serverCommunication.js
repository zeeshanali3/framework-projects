/* Frontend Objects for table: lecturesattendance */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_lecturesattendance',
                        onAction: () => console.log("Button pressed Edit"),
                        form: lecturesattendance generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/lecturesattendance?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_lecturesattendance',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_lecturesattendance',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/lecturesattendance?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_lecturesattendance',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_lecturesattendance',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "lecturesattendance_attendanceId", "lecturesattendance_enrollementId", "lecturesattendance_date", "lecturesattendance_isPresent", "lecturesattendance_subComponentId", "lecturesattendance_status", "lecturesattendance_createdBy", "lecturesattendance_updatedBy", "lecturesattendance_createdAt", "lecturesattendance_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_lecturesattendance',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_lecturesattendance',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/lecturesattendance?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_lecturesattendance',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/lecturesattendance?version=1.0",
                        apiActionType: "lecturesattendance_view",
                        requestType: "GET",
                        reduxActionType: "lecturesattendance_view",
                    }),
                    options: {
                        pageSize: 10,
