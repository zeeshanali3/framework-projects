/* Frontend Objects for table: lecturetopics */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_lecturetopics',
                        onAction: () => console.log("Button pressed Edit"),
                        form: lecturetopics generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/lecturetopics?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_lecturetopics',
                    ...
                    export: {
                      permission: 'export_lecturetopics',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_lecturetopics',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "lecturetopics_lecturesTopicId", "lecturetopics_subComponentId", "lecturetopics_topicName", "lecturetopics_description", "lecturetopics_bookId", "lecturetopics_status", "lecturetopics_createdBy", "lecturetopics_updatedBy", "lecturetopics_createdAt", "lecturetopics_updatedAt"
                        ],
                    ...
                    search: {
                    permission: 'search_lecturetopics',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/lecturetopics?version=1.0",
                        apiActionType: "lecturetopics_view",
                        requestType: "GET",
                        reduxActionType: "lecturetopics_view",
                    }),
                    options: {
                        pageSize: 10,
