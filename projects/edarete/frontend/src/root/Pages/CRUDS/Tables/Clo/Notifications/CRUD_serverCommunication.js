/* Frontend Objects for table: notifications */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: notifications generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/notifications?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    export: {
                      permission: 'export_notifications',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_notifications',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "notifications_notificationId", "notifications_notificationTitle", "notifications_notificationMessage", "notifications_sentToUserRoleDesignationDepartmentId", "notifications_createdBy", "notifications_updatedBy", "notifications_status", "notifications_createdAt", "notifications_updatedAt"
                        ],
                    ...
                    search: {
                    permission: 'search_notifications',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/notifications?version=1.0",
                        apiActionType: "notifications_view",
                        requestType: "GET",
                        reduxActionType: "notifications_view",
                    }),
                    options: {
                        pageSize: 10,
