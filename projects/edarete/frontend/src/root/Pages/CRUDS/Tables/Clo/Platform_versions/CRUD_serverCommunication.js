/* Frontend Objects for table: platform_versions */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_platform_versions',
                        onAction: () => console.log("Button pressed Edit"),
                        form: platform_versions generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/platform_versions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_platform_versions',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_platform_versions',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/platform_versions?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_platform_versions',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_platform_versions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "platform_versions_platformVersionId", "platform_versions_versionId", "platform_versions_platformId", "platform_versions_encryptionKey", "platform_versions_createdBy", "platform_versions_updatedBy", "platform_versions_status", "platform_versions_createdAt", "platform_versions_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_platform_versions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_platform_versions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/platform_versions?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_platform_versions',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/platform_versions?version=1.0",
                        apiActionType: "platform_versions_view",
                        requestType: "GET",
                        reduxActionType: "platform_versions_view",
                    }),
                    options: {
                        pageSize: 10,
