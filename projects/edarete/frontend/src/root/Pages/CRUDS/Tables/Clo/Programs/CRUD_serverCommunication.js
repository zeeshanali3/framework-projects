/* Frontend Objects for table: programs */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_programs',
                        onAction: () => console.log("Button pressed Edit"),
                        form: programs generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/programs?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "programs_programId", "programs_departmentId", "programs_domainId", "programs_programName", "programs_programYear", "programs_status", "programs_createdBy", "programs_updatedBy", "programs_createdAt", "programs_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/programs?version=1.0",
                        apiActionType: "programs_view",
                        requestType: "GET",
                        reduxActionType: "programs_view",
                    }),
                    options: {
                        pageSize: 10,
