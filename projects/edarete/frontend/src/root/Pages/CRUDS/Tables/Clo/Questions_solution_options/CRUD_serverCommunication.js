            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_questions_solution_options',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/questions_solution_options?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_questions_solution_options',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_questions_solution_options',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/questions_solution_options?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_questions_solution_options',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_questions_solution_options',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "questions_solution_options_questionsSolutionOptionsId", "questions_solution_options_questionId", "questions_solution_options_description", "questions_solution_options_optionNumber", "questions_solution_options_correctOption"
                        ],
                    ...
                    sort: {
                    permission: 'sort_questions_solution_options',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_questions_solution_options',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/questions_solution_options?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_questions_solution_options',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/questions_solution_options?version=1.0",
                          apiActionType: "questions_solution_options_view",
                          requestType: "GET",
                          reduxActionType: "questions_solution_options_view",
                      }),
                      options: {
                          pageSize: 10,
