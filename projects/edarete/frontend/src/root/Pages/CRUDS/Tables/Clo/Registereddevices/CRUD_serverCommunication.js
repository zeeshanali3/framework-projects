            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_registereddevices',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/registereddevices?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_registereddevices',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_registereddevices',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/registereddevices?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_registereddevices',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_registereddevices',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "registereddevices_deviceId", "registereddevices_deviceName", "registereddevices_deviceToken", "registereddevices_deviceType", "registereddevices_accessToken", "registereddevices_tokenExpiry", "registereddevices_deviceOs", "registereddevices_make", "registereddevices_status", "registereddevices_createdBy", "registereddevices_updatedBy", "registereddevices_createdAt", "registereddevices_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_registereddevices',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_registereddevices',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/registereddevices?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_registereddevices',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/registereddevices?version=1.0",
                          apiActionType: "registereddevices_view",
                          requestType: "GET",
                          reduxActionType: "registereddevices_view",
                      }),
                      options: {
                          pageSize: 10,
