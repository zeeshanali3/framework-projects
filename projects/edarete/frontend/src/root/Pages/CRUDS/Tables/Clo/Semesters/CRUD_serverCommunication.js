/* Frontend Objects for table: semesters */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_semesters',
                        onAction: () => console.log("Button pressed Edit"),
                        form: semesters generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/semesters?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "semesters_semesterId", "semesters_programId", "semesters_semesterNum", "semesters_startDate", "semesters_endDate", "semesters_semesterName", "semesters_status", "semesters_createdBy", "semesters_updatedBy", "semesters_createdAt", "semesters_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/semesters?version=1.0",
                        apiActionType: "semesters_view",
                        requestType: "GET",
                        reduxActionType: "semesters_view",
                    }),
                    options: {
                        pageSize: 10,
