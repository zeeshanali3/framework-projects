/* Frontend Objects for table: students */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: students generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/students?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "students_studentUserId", "students_urddId", "students_programId", "students_batch", "students_regNum", "students_status", "students_createdBy", "students_updatedBy", "students_createdAt", "students_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/students?version=1.0",
                        apiActionType: "students_view",
                        requestType: "GET",
                        reduxActionType: "students_view",
                    }),
                    options: {
                        pageSize: 10,
