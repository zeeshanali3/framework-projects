            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_topicquestions',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/topicquestions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_topicquestions',
                    ...
                    export: {
                      permission: 'export_topicquestions',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_topicquestions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "topicquestions_topicQuestionId", "topicquestions_lectureTopicId", "topicquestions_questionType", "topicquestions_question", "topicquestions_isDone", "topicquestions_createdAtDate", "topicquestions_createdAtTime", "topicquestions_updatedAtDate", "topicquestions_updatedAtTime", "topicquestions_status", "topicquestions_createdBy", "topicquestions_updatedBy", "topicquestions_createdAt", "topicquestions_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_topicquestions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_topicquestions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/topicquestions?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_topicquestions',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/topicquestions?version=1.0",
                          apiActionType: "topicquestions_view",
                          requestType: "GET",
                          reduxActionType: "topicquestions_view",
                      }),
                      options: {
                          pageSize: 10,
