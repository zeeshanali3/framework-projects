/* Frontend Objects for table: versions */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_versions',
                        onAction: () => console.log("Button pressed Edit"),
                        form: versions generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/versions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "versions_versionId", "versions_version", "versions_createdBy", "versions_updatedBy", "versions_status", "versions_createdAt", "versions_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/versions?version=1.0",
                        apiActionType: "versions_view",
                        requestType: "GET",
                        reduxActionType: "versions_view",
                    }),
                    options: {
                        pageSize: 10,
