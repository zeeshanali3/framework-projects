/* Frontend Objects for table: course_requests */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_course_requests',
                        onAction: () => console.log("Button pressed Edit"),
                        form: course_requests generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/course_requests?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_course_requests',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_course_requests',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/course_requests?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_course_requests',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_course_requests',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "course_requests_courseRequestId", "course_requests_courseId", "course_requests_studentUrddId"
                        ],
                    ...
                    sort: {
                    permission: 'sort_course_requests',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_course_requests',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/course_requests?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_course_requests',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/course_requests?version=1.0",
                        apiActionType: "course_requests_view",
                        requestType: "GET",
                        reduxActionType: "course_requests_view",
                    }),
                    options: {
                        pageSize: 10,
