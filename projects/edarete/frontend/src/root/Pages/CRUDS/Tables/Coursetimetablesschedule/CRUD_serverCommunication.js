            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_coursetimetablesschedule',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/coursetimetablesschedule?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_coursetimetablesschedule',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_coursetimetablesschedule',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/coursetimetablesschedule?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_coursetimetablesschedule',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_coursetimetablesschedule',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "coursetimetablesschedule_courseLscheduleId", "coursetimetablesschedule_courseId", "coursetimetablesschedule_employeePreferedTimeSlotsId", "coursetimetablesschedule_timeSlotId", "coursetimetablesschedule_roomId", "coursetimetablesschedule_status", "coursetimetablesschedule_createdBy", "coursetimetablesschedule_updatedBy", "coursetimetablesschedule_createdAt", "coursetimetablesschedule_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_coursetimetablesschedule',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_coursetimetablesschedule',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/coursetimetablesschedule?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_coursetimetablesschedule',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/coursetimetablesschedule?version=1.0",
                          apiActionType: "coursetimetablesschedule_view",
                          requestType: "GET",
                          reduxActionType: "coursetimetablesschedule_view",
                      }),
                      options: {
                          pageSize: 10,
