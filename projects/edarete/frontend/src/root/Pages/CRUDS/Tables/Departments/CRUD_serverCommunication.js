/* Frontend Objects for table: departments */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: departments generateFormProps({
                            parameters: parameters,
                    ...
                    options: {
                        filterBy: [
                            "departments_departmentId", "departments_departmentName", "departments_employeeId", "departments_status", "departments_createdBy", "departments_updatedBy", "departments_createdAt", "departments_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/departments?version=1.0",
                        apiActionType: "departments_view",
                        requestType: "GET",
                        reduxActionType: "departments_view",
                    }),
                    options: {
                        pageSize: 10,
