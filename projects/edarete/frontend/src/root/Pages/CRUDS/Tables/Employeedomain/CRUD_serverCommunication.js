            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_employeedomain',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/employeedomain?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_employeedomain',
                    ...
                    export: {
                      permission: 'export_employeedomain',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_employeedomain',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "employeedomain_employeeDomainId", "employeedomain_employeeId", "employeedomain_domainId", "employeedomain_status", "employeedomain_createdBy", "employeedomain_updatedBy", "employeedomain_createdAt", "employeedomain_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_employeedomain',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_employeedomain',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/employeedomain?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_employeedomain',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/employeedomain?version=1.0",
                          apiActionType: "employeedomain_view",
                          requestType: "GET",
                          reduxActionType: "employeedomain_view",
                      }),
                      options: {
                          pageSize: 10,
