            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_employeepreferedtimeslots',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/employeepreferedtimeslots?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_employeepreferedtimeslots',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_employeepreferedtimeslots',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/employeepreferedtimeslots?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_employeepreferedtimeslots',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_employeepreferedtimeslots',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "employeepreferedtimeslots_employeePreferedTimeSlotsId", "employeepreferedtimeslots_employeeId", "employeepreferedtimeslots_timeSlotId", "employeepreferedtimeslots_status", "employeepreferedtimeslots_createdBy", "employeepreferedtimeslots_updatedBy", "employeepreferedtimeslots_createdAt", "employeepreferedtimeslots_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_employeepreferedtimeslots',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_employeepreferedtimeslots',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/employeepreferedtimeslots?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_employeepreferedtimeslots',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/employeepreferedtimeslots?version=1.0",
                          apiActionType: "employeepreferedtimeslots_view",
                          requestType: "GET",
                          reduxActionType: "employeepreferedtimeslots_view",
                      }),
                      options: {
                          pageSize: 10,
