            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_enrollements',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/enrollements?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_enrollements',
                    ...
                    export: {
                      permission: 'export_enrollements',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_enrollements',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "enrollements_enrollementId", "enrollements_studentSemesterId", "enrollements_grade", "enrollements_groupName", "enrollements_enrolledDate", "enrollements_courseId", "enrollements_status", "enrollements_createdBy", "enrollements_updatedBy", "enrollements_createdAt", "enrollements_updatedAt"
                        ],
                    ...
                    search: {
                    permission: 'search_enrollements',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/enrollements?version=1.0",
                          apiActionType: "enrollements_view",
                          requestType: "GET",
                          reduxActionType: "enrollements_view",
                      }),
                      options: {
                          pageSize: 10,
