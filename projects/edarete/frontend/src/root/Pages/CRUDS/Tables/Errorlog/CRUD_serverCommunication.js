            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_errorlog',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/errorlog?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "errorlog_errorId", "errorlog_errorMessage", "errorlog_fileName", "errorlog_status", "errorlog_createdBy", "errorlog_updatedBy", "errorlog_createdAt", "errorlog_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/errorlog?version=1.0",
                          apiActionType: "errorlog_view",
                          requestType: "GET",
                          reduxActionType: "errorlog_view",
                      }),
                      options: {
                          pageSize: 10,
