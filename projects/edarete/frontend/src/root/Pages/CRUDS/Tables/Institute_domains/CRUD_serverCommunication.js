/* Frontend Objects for table: institute_domains */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_institute_domains',
                        onAction: () => console.log("Button pressed Edit"),
                        form: institute_domains generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/institute_domains?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_institute_domains',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_institute_domains',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/institute_domains?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_institute_domains',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_institute_domains',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "institute_domains_instituteDomainId", "institute_domains_instituteId", "institute_domains_domainId"
                        ],
                    ...
                    sort: {
                    permission: 'sort_institute_domains',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_institute_domains',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/institute_domains?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_institute_domains',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/institute_domains?version=1.0",
                        apiActionType: "institute_domains_view",
                        requestType: "GET",
                        reduxActionType: "institute_domains_view",
                    }),
                    options: {
                        pageSize: 10,
