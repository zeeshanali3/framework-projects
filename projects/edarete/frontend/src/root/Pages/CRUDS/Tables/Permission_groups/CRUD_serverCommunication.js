/* Frontend Objects for table: permission_groups */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: permission_groups generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/permission_groups?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_permission_groups',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/permission_groups?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_permission_groups',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_permission_groups',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "permission_groups_permissionGroupId", "permission_groups_groupName", "permission_groups_createdBy", "permission_groups_updatedBy", "permission_groups_status", "permission_groups_createdAt", "permission_groups_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_permission_groups',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_permission_groups',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/permission_groups?version=1.0",
                        apiActionType: "permission_groups_view",
                        requestType: "GET",
                        reduxActionType: "permission_groups_view",
                    }),
                    options: {
                        pageSize: 10,
