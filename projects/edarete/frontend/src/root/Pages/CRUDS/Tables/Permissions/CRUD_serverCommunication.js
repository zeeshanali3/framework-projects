/* Frontend Objects for table: permissions */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: permissions generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/permissions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "permissions_permissionId", "permissions_permissionName", "permissions_permissionName", "permissions_createdBy", "permissions_updatedBy", "permissions_status", "permissions_createdAt", "permissions_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/permissions?version=1.0",
                        apiActionType: "permissions_view",
                        requestType: "GET",
                        reduxActionType: "permissions_view",
                    }),
                    options: {
                        pageSize: 10,
