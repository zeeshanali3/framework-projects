/* Frontend Objects for table: plo */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_plo',
                        onAction: () => console.log("Button pressed Edit"),
                        form: plo generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/plo?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "plo_ploid", "plo_programId", "plo_ploname", "plo_plonum", "plo_status", "plo_createdBy", "plo_updatedBy", "plo_createdAt", "plo_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/plo?version=1.0",
                        apiActionType: "plo_view",
                        requestType: "GET",
                        reduxActionType: "plo_view",
                    }),
                    options: {
                        pageSize: 10,
