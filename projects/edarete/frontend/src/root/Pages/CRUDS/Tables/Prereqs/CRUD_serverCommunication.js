/* Frontend Objects for table: prereqs */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_prereqs',
                        onAction: () => console.log("Button pressed Edit"),
                        form: prereqs generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/prereqs?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "prereqs_preReqsId", "prereqs_plannedCourseId", "prereqs_preReqCourseId", "prereqs_status", "prereqs_createdBy", "prereqs_updatedBy", "prereqs_createdAt", "prereqs_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/prereqs?version=1.0",
                        apiActionType: "prereqs_view",
                        requestType: "GET",
                        reduxActionType: "prereqs_view",
                    }),
                    options: {
                        pageSize: 10,
