/* Frontend Objects for table: questionssolution */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_questionssolution',
                        onAction: () => console.log("Button pressed Edit"),
                        form: questionssolution generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/questionssolution?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_questionssolution',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_questionssolution',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/questionssolution?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_questionssolution',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_questionssolution',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    sort: {
                    permission: 'sort_questionssolution',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_questionssolution',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/questionssolution?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_questionssolution',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/questionssolution?version=1.0",
                        apiActionType: "questionssolution_view",
                        requestType: "GET",
                        reduxActionType: "questionssolution_view",
                    }),
                    options: {
                        pageSize: 10,
