/* Frontend Objects for table: questionssolutions */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_questionssolutions',
                        onAction: () => console.log("Button pressed Edit"),
                        form: questionssolutions generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/questionssolutions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_questionssolutions',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_questionssolutions',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/questionssolutions?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_questionssolutions',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_questionssolutions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "questionssolutions_questionsHelpGuideId", "questionssolutions_status", "questionssolutions_createdBy", "questionssolutions_updatedBy", "questionssolutions_createdAt", "questionssolutions_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_questionssolutions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_questionssolutions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/questionssolutions?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_questionssolutions',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/questionssolutions?version=1.0",
                        apiActionType: "questionssolutions_view",
                        requestType: "GET",
                        reduxActionType: "questionssolutions_view",
                    }),
                    options: {
                        pageSize: 10,
