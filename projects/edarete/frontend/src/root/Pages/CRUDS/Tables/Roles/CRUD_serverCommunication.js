/* Frontend Objects for table: roles */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: roles generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/roles?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "roles_roleId", "roles_roleName", "roles_status", "roles_createdBy", "roles_updatedBy", "roles_createdAt", "roles_updatedAt"
                        ],
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/roles?version=1.0",
                        apiActionType: "roles_view",
                        requestType: "GET",
                        reduxActionType: "roles_view",
                    }),
                    options: {
                        pageSize: 10,
