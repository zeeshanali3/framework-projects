                ...
                features: {
                    ...
                    actions: [
                        ...
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/rooms?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                    ...
                    options: {
                        filterBy: [
                            "rooms_roomId", "rooms_roomName", "rooms_roomCapacity", "rooms_roomLocation", "rooms_status", "rooms_createdBy", "rooms_updatedBy", "rooms_createdAt", "rooms_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/rooms?version=1.0",
                          apiActionType: "rooms_view",
                          requestType: "GET",
                          reduxActionType: "rooms_view",
                      }),
                      options: {
                          pageSize: 10,
