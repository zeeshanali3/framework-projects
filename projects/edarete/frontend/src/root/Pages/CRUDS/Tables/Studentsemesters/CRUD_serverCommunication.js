            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_studentsemesters',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/studentsemesters?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_studentsemesters',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_studentsemesters',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsemesters?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_studentsemesters',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_studentsemesters',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    sort: {
                    permission: 'sort_studentsemesters',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_studentsemesters',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsemesters?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_studentsemesters',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/studentsemesters?version=1.0",
                          apiActionType: "studentsemesters_view",
                          requestType: "GET",
                          reduxActionType: "studentsemesters_view",
                      }),
                      options: {
                          pageSize: 10,
