            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_studentsubmissionattachment',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/studentsubmissionattachment?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_studentsubmissionattachment',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_studentsubmissionattachment',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsubmissionattachment?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_studentsubmissionattachment',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_studentsubmissionattachment',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "studentsubmissionattachment_studentSubmissionAttachmentId", "studentsubmissionattachment_studentSubmissionId", "studentsubmissionattachment_attachementId", "studentsubmissionattachment_status", "studentsubmissionattachment_createdBy", "studentsubmissionattachment_updatedBy", "studentsubmissionattachment_createdAt", "studentsubmissionattachment_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_studentsubmissionattachment',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_studentsubmissionattachment',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsubmissionattachment?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_studentsubmissionattachment',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/studentsubmissionattachment?version=1.0",
                          apiActionType: "studentsubmissionattachment_view",
                          requestType: "GET",
                          reduxActionType: "studentsubmissionattachment_view",
                      }),
                      options: {
                          pageSize: 10,
