            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_studentsubmissions',
                        onAction: () => console.log("Button pressed Edit"),
                        form: generateFormProps({
                            parameters: parameters,
                            apiUrl: "/grouped/cruds/studentsubmissions?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_studentsubmissions',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_studentsubmissions',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsubmissions?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_studentsubmissions',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_studentsubmissions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "studentsubmissions_studentSubmissionId", "studentsubmissions_subComponentId", "studentsubmissions_enrollmentId", "studentsubmissions_status", "studentsubmissions_createdBy", "studentsubmissions_updatedBy", "studentsubmissions_createdAt", "studentsubmissions_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_studentsubmissions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_studentsubmissions',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/studentsubmissions?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_studentsubmissions',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/studentsubmissions?version=1.0",
                          apiActionType: "studentsubmissions_view",
                          requestType: "GET",
                          reduxActionType: "studentsubmissions_view",
                      }),
                      options: {
                          pageSize: 10,
