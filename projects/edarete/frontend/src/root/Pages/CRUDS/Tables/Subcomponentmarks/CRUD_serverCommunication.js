/* Frontend Objects for table: subcomponentmarks */
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    actions: [
                        ...
                        name: "Edit",
                        color: "blue",
                        permission: 'update_subcomponentmarks',
                        onAction: () => console.log("Button pressed Edit"),
                        form: subcomponentmarks generateFormProps({
                            parameters: parameters,
                            apiUrl: "/crud/subcomponentmarks?version=1.0",
                            requestType: "PUT",
                            mode:"edit"
                        }),
                        },
                        ...
                        name: "Delete",
                        color: "red",
                        permission: 'delete_subcomponentmarks',
                    ...
                    bulkAction: {
                    add: {
                        permission:'add_subcomponentmarks',
                        form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/crud/subcomponentmarks?version=1.0",
                        requestType: "POST",
                    ...
                    export: {
                      permission: 'export_subcomponentmarks',
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "",
                          apiActionType: "",
                    ...
                    filter: {
                    permission: 'filter_subcomponentmarks',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    options: {
                        filterBy: [
                            "subcomponentmarks_subComponentMarkId", "subcomponentmarks_subComponentId", "subcomponentmarks_enrollmentId", "subcomponentmarks_obtainedMarks", "subcomponentmarks_outOfMarks", "subcomponentmarks_status", "subcomponentmarks_createdBy", "subcomponentmarks_updatedBy", "subcomponentmarks_createdAt", "subcomponentmarks_updatedAt"
                        ],
                    ...
                    sort: {
                    permission: 'sort_subcomponentmarks',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                        apiActionType: "",
                    ...
                    list: {
                    permission:'list_subcomponentmarks',
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl:  "/crud/subcomponentmarks?version=1.0",
                        apiActionType: "",
                    ...
                    search: {
                    permission: 'search_subcomponentmarks',
                    excludeSearch: ["image"],
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "",
                    ...
                    serverCommunication: serverCommunicationHelper({
                        parameters: parameters,
                        apiUrl: "/crud/subcomponentmarks?version=1.0",
                        apiActionType: "subcomponentmarks_view",
                        requestType: "GET",
                        reduxActionType: "subcomponentmarks_view",
                    }),
                    options: {
                        pageSize: 10,
