import { parameters } from "./CRUD_parameters.js";
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    options: {
                        filterBy: [
                            "user_devices_userDeviceId", "user_devices_userId", "user_devices_deviceToken", "user_devices_deviceName", "user_devices_platformVersionId", "user_devices_osVersion", "user_devices_createdBy", "user_devices_updatedBy", "user_devices_status", "user_devices_createdAt", "user_devices_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl: "/crud/user_devices?version=1.0",
                          apiActionType: "user_devices_view",
                          requestType: "GET",
                          reduxActionType: "user_devices_view",
                      }),
                      options: {
                          pageSize: 10,
