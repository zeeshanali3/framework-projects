import { parameters } from "./CRUD_parameters.js";
            ...
            export const listing_crud_props = {
                ...
                features: {
                    ...
                    options: {
                        filterBy: [
                            "users_userId", "users_email", "users_username", "users_firstName", "users_lastName", "users_phoneNo", "users_password", "users_cnic", "users_gender", "users_fatherName", "users_imageAttachmentId", "users_address", "users_dateOfBirth", "users_bloodGroup", "users_religion", "users_lastLogin", "users_status", "users_createdBy", "users_updatedBy", "users_createdAt", "users_updatedAt"
                        ],
                    ...
                    pagination: {
                      ...
                      serverCommunication: serverCommunicationHelper({
                          ...
                          apiActionType: "users_view",
                          requestType: "GET",
                          reduxActionType: "users_view",
                      }),
                      options: {
                          pageSize: 10,
